...
var SVG_ATTRS_ADJUSTMENT_MAP = new Map([
    ...
    'yChannelSelector',
    'zoomAndPan',
].map(function (attr) { return [attr.toLowerCase(), attr]; }));
...
exports.SVG_TAG_NAMES_ADJUSTMENT_MAP = new Map([
    ...
    'radialGradient',
    'textPath',
].map(function (tn) { return [tn.toLowerCase(), tn]; }));
...
function causesExit(startTagToken) {
    ...
    var isFontWithAttrs = tn === html_js_1.TAG_ID.FONT &&
        startTagToken.attrs.some(function (_a) {
            var name = _a.name;
