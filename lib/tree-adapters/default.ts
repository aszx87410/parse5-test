import { DOCUMENT_MODE, type NS } from "../common/html";
import type { Attribute, Location, ElementLocation } from "../common/token";
import type { TreeAdapter, TreeAdapterTypeMap } from "./interface";
